...
import { e as BlockLabel, f as Image, g as Empty, h as IconButtonWrapper, i as IconButton, M as Maximize, D as Download, o as ShareButton, u as uploadToHuggingFace } from './2-9Q2E4iJ-.js';
...
const ImagePreview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}` : `<div class="image-container svelte-dpdy90"${add_attribute("this", image_container, 0)}>${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
...
//# sourceMappingURL=ImagePreview-QRaZPAVi.js.map
