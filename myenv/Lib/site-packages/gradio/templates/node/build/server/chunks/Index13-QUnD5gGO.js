...
import { B as Block, S as Static, e as BlockLabel, W as Code$2, g as Empty, i as IconButton, K as Copy$1, D as Download$1, h as IconButtonWrapper } from './2-9Q2E4iJ-.js';
...
const lang_map = {
  python: () => import('./index27-CO4o0CrQ.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-BnC-Zxpx.js'),
      import('./frontmatter-BSfO0zd1.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-C1wMapmQ.js').then((m) => m.json()),
  html: () => import('./index29-CbFMrOhA.js').then((m) => m.html()),
  css: () => import('./index30-BrEqy-TR.js').then((m) => m.css()),
  javascript: () => import('./index31-OX-OLw_e.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-OX-OLw_e.js').then(
...
//# sourceMappingURL=Index13-QUnD5gGO.js.map
